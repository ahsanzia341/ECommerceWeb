        ...
        <div class="form-group floating-label">
            {{ Form::text('enabled', $promoCode->enabled, ['class' => 'form-control' . ($errors->has('enabled') ? ' is-invalid' : '')]) }}
            <label for="enabled">Enabled</label>
            {!! $errors->first('enabled', '<div class="invalid-feedback">:message</p>') !!}
        </div>

        <div class="form-group floating-label">
            {{ Form::text('start_date', $promoCode->start_date, ['class' => 'form-control' . ($errors->has('start_date') ? ' is-invalid' : '')]) }}
            <label for="start_date">Start Date</label>
            {!! $errors->first('start_date', '<div class="invalid-feedback">:message</p>') !!}
        </div>

        <div class="form-group floating-label">
            {{ Form::text('end_date', $promoCode->end_date, ['class' => 'form-control' . ($errors->has('end_date') ? ' is-invalid' : '')]) }}
